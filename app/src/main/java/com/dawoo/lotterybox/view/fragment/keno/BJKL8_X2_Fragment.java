...
public class BJKL8_X2_Fragment extends BaseFragment {
    ...
    private void initData() {
        mList = XYBDataUtils.initBJKL8ChooseData(2);
        ...
        mTvPlayTypeName.setText(mList.get(0).getPlayTypeName() + "(中2@" + mList.get(0).getScheme() + "）");
    ...
    public void randomSelected(String id) {
        if (!isHidden()) {
            ...
            int[] randomChild = XYBDataUtils.getRandomList(2, 0, mListLinkedHashMap.get(mList.get(randomparent).getPlayTypeName()).size());
