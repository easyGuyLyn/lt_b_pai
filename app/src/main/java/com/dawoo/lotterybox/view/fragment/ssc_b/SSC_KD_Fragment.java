...
public class SSC_KD_Fragment extends BaseFragment {
    ...
    private String playName = BoxApplication.getContext().getString(R.string.q3kd);
    private int mCurrentPostion = 0;

    public SSC_KD_Fragment() {
    }
    ...
    private void initData() {
        ...
        for (PlayTypeBean.PlayBean playBean : mList) {
            mListLinkedHashMap.put(playBean.getPlayTypeName(), SSCBDataUtil.init_KD_0_9_Data(
