...
public class SSC_SZP_Fragment extends BaseFragment {
    ...
    private void initData() {
        ThreadUtils.newThread(new Runnable() {
            ...
            public void run() {
                selectedBean.clear();
                mList = SSCBDataUtil.initSZPData();
                for (PlayTypeBean.PlayBean playBean : mList) {
                    mListLinkedHashMap.put(playBean.getPlayTypeName(), SSCBDataUtil.init_SZP_0_9Data(playBean.getPlayTypeName()));
                }
                ...
                public void run() {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mAdapter.notifyDataSetChanged();
                            mRvSzpPlayType.smoothScrollToPosition((randomType));
