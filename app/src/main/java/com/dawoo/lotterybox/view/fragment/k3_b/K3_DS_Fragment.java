...
public class K3_DS_Fragment extends BaseFragment {
    ...
    private void initData() {
        ThreadUtils.newThread(new Runnable() {
            @Override
            public void run() {
                mList = K3DataUtil.initDSData();
                for (PlayTypeBean.PlayBean playBean : mList) {
                    mListLinkedHashMap.put(playBean.getPlayTypeName(), K3DataUtil.init_DS_Data(playBean.getPlayTypeName()));
                }
        ...
        if (!isHidden()) {
            ThreadUtils.newThread(new Runnable() {
                ...
                public void run() {
                    ...
                    int randomType = RandomUtils.randInt(mList.size());
