...
public class OpenLotteryK3View extends LinearLayout implements View.OnClickListener , ILastLotteryRecView {
    ...
    TextView mSscTime;
    @BindView(R.id.k3_ball_one_tv)
    TextView mK3BallOneTv;
    @BindView(R.id.k3_ball_tow_tv)
    TextView mK3BallTowTv;
    @BindView(R.id.k3_ball_three_tv)
    TextView mK3BallThreeTv;
    @BindView(R.id.k3_lable_sum_tv)
    TextView mK3LableSumTv;
    @BindView(R.id.k3_value_sum_tv)
    TextView mK3ValueSumTv;
    @BindView(R.id.line_vertical)
    TextView mLineVertical;
    @BindView(R.id.k3_lable_group_tv)
    TextView mK3LableGroupTv;
    @BindView(R.id.lable_count_time)
    TextView mLableCountTime;
    @BindView(R.id.k3_value_count_time)
    ...
    public OpenLotteryK3View(Context context, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context);
        initUI(context);
    }

    public OpenLotteryK3View(Context context, @Nullable AttributeSet attrs, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context, attrs);
        initUI(context);
    }

    public OpenLotteryK3View(Context context, @Nullable AttributeSet attrs, int defStyleAttr, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context, attrs, defStyleAttr);
        initUI(context);
    }


    public OpenLotteryK3View(Context context) {
        super(context);
        initUI(context);
    }
    ...
    private void initUI(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_lottery_rcd_k3, null);
    ...
    public void setViewsData() {
        ...
        if (rcd.getLastOpenCode() != null && 5 == rcd.getLastOpenCode().length()) {
            ...
            mK3BallOneTv.setBackgroundResource(getBgK3(lastOpenCode[0]));
            mK3BallTowTv.setBackgroundResource(getBgK3(lastOpenCode[1]));
            mK3BallThreeTv.setBackgroundResource(getBgK3(lastOpenCode[2]));

            mK3ValueSumTv.setText("" + K3Util.getHeZhi(lastOpenCode));
            mK3LableGroupTv.setText(K3Util.getK3SanBuTongHao(lastOpenCode));
        }
