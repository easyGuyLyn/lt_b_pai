...
public class XY28_HH_Fragment extends BaseFragment {
    ...
    private void initViews() {
        mAdapter = new SZPDetailAdapter(R.layout.click_play_type_item_layout);
    ...
    private void initData() {
        ThreadUtils.newThread(new Runnable() {
            @Override
            public void run() {
                mList = XYBDataUtils.initXy28HHData();
                for (PlayTypeBean.PlayBean playBean : mList) {
                    mListLinkedHashMap.put(playBean.getPlayTypeName(), XYBDataUtils.init_Xy28_HH_Data(playBean.getPlayTypeName()));
                }
