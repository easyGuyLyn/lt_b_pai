...
import com.dawoo.lotterybox.adapter.ShowPopwindowAdapter;
...
public class AllFragment extends BaseFragment implements View.OnClickListener {
    ...
    @BindView(R.id.bill_details_all＿betting_total)
    TextView billdetailsAll_bettingTotal;
    @BindView(R.id.bill_details_all_winning_amount_vis)
    TextView billDetailsAllWinningAmountVis;
    @BindView(R.id.bill_details_all_winning_amount_gone)
    ImageView billDetailsAllWinningAmountGone;
    @BindView(R.id.bill_details_all_total_withdrawals_chedan)
    TextView billDetailsAllTotalWithdrawalsChedan;
    @BindView(R.id.bill_details_all_rebate_total)
    TextView billDetailsAllRebateTotal;
    ...
    @BindView(R.id.bill_details_all_total_gifs)
    TextView billDetailsAllTotalGifs;
    @BindView(R.id.bill_details_all_into_total)
    TextView billDetailsAllIntoTotal;
    ...
    private ShowPopwindowAdapter ShowPopwindowAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_billing_details_all, container, false);
    ...
    private void ClickListener() {
        bottomSheetLayout.setOnProgressListener(v -> {
            billDetailsAllWinningAmountGone.animate().rotation(-180*v);
        });
        ...
        billDetailsAllWinningAmountVis.setOnClickListener(this::onClick);
        billDetailsAllWinningAmountGone.setOnClickListener(this::onClick);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            //ｖｉｓ
            case R.id.bill_details_all_winning_amount_vis:
//                gameRecordBootom.setVisibility(View.VISIBLE);
//                billDetailsAllWinningAmountVis.setVisibility(View.GONE);
//                billDetailsAllWinningAmountGone.setVisibility(View.VISIBLE);
                break;
            //gon
            case R.id.bill_details_all_winning_amount_gone:
...
//                bill_details_all_allList<View> popupViews = new ArrayList<>();
//                MSPropties.showMeg(getActivity(), "11");
//                final View constellationView = getLayoutInflater().inflate(R.layout.show_popwindow, null);
//                GridView constellation = ButterKnife.findById(constellationView, R.id.constellation);
//                ShowPopwindowAdapter = new ShowPopwindowAdapter(getActivity(), Arrays.asList(constellations));
//                constellation.setAdapter(ShowPopwindowAdapter);
//                MSPropties.showMeg(getActivity(), "２２");
//                dropDownMenu.setDropDownMenu(Arrays.asList(ss), billDetailsAllAll, constellationView);
//                break;
            default:
        }
    }
    private void getNextDay() {
        ...
        Date date = DateTool.stringM2Date(END_Time);
        assert date != null;
        Date nextData = new Date(date.getTime() + addTime);
        END_Time = DateTool.convert2String(nextData, DateTool.FMT_DATE);
    }
