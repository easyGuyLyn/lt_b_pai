...
public class K3_DP_Fragment extends BaseFragment {
    ...
    private void initData() {
        ...
        mList = K3DataUtil.initDPData();
        for (PlayTypeBean.PlayBean playBean : mList) {
            mListLinkedHashMap.put(playBean.getPlayTypeName(), K3DataUtil.init_DP_Data(playBean.getPlayTypeName()));
        }
    ...
    private class SZPDetailAdapter extends BaseQuickAdapter {
        ...
        protected void convert(BaseViewHolder helper, Object item) {
            ...
            char[] chars = playDetailBean.getNum().toCharArray();
            helper.setBackgroundRes(R.id.tv_playType, K3DataUtil.getFastIcon(chars[0] + ""));
            helper.setBackgroundRes(R.id.tv_playType1, K3DataUtil.getFastIcon(chars[1] + ""));
            if (changeType == 1) {
