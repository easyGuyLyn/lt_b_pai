...
public class BJKL8_X3_Fragment extends BaseFragment {
    ...
    private void initData() {
        mList = XYBDataUtils.initBJKL8ChooseData(3);
        ...
        mTvPlayTypeName.setText(mList.get(0).getPlayTypeName() + "(中3@" + add[0] + " " + "中2@" + add[1] + "）");
    ...
    public void randomSelected(String id) {
        if (!isHidden()) {
            ...
            int[] randomChild = XYBDataUtils.getRandomList(3, 0, mListLinkedHashMap.get(mList.get(randomparent).getPlayTypeName()).size());
