...
public class Cqxync_Six_Fragment extends BaseFragment {
    ...
    private void initData() {
        ...
        for (PlayTypeBean.PlayBean playBean : mList) {
            mListLinkedHashMap.put(playBean.getPlayTypeName(), Cqxync_DataUtils.init_CQXYNC_LH_Data(playBean.getPlayTypeName(), getResources().getString(R.string.sixth_ball)));
        }
