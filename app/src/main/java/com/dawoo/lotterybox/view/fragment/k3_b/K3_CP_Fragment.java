...
public class K3_CP_Fragment extends BaseFragment {
    ...
    private void initData() {
        ...
        mList = K3DataUtil.initCPData();
        for (PlayTypeBean.PlayBean playBean : mList) {
            mListLinkedHashMap.put(playBean.getPlayTypeName(), K3DataUtil.init_CP_Data(playBean.getPlayTypeName()));
        }
