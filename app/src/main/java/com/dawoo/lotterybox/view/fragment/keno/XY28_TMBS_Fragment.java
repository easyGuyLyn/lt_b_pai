...
public class XY28_TMBS_Fragment extends BaseFragment {
    ...
    private void initData() {
        mList = XYBDataUtils.init28TMBSData();
        for (PlayTypeBean.PlayBean playBean : mList) {
            mListLinkedHashMap.put(playBean.getPlayTypeName(), XYBDataUtils.init_Xy28_TMBS_Data(playBean.getPlayTypeName()));
        }
