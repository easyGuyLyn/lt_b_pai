...
public class OpenLotteryLHCView extends LinearLayout implements View.OnClickListener , ILastLotteryRecView {
    ...
    TextView mSscTime;
    @BindView(R.id.lhc_ball_one_tv)
    TextView mLhcBallOneTv;
    @BindView(R.id.lhc_animal_one_tv)
    TextView mLhcAnimalOneTv;
    @BindView(R.id.lhc_ball_two_tv)
    TextView mLhcBallTwoTv;
    @BindView(R.id.lhc_animal_two_tv)
    TextView mLhcAnimalTwoTv;
    @BindView(R.id.lhc_ball_three_tv)
    TextView mLhcBallThreeTv;
    @BindView(R.id.lhc_animal_three_tv)
    TextView mLhcAnimalThreeTv;
    @BindView(R.id.lhc_ball_four_tv)
    TextView mLhcBallFourTv;
    @BindView(R.id.lhc_animal_four_tv)
    TextView mLhcAnimalFourTv;
    @BindView(R.id.lhc_ball_five_tv)
    TextView mLhcBallFiveTv;
    @BindView(R.id.lhc_animal_five_tv)
    TextView mLhcAnimalFiveTv;
    @BindView(R.id.lhc_ball_six_tv)
    TextView mLhcBallSixTv;
    @BindView(R.id.lhc_animal_six_tv)
    TextView mLhcAnimalSixTv;
    @BindView(R.id.lhc_ball_seven_tv)
    TextView mLhcBallSevenTv;
    @BindView(R.id.lhc_animal_seven_tv)
    TextView mLhcAnimalSevenTv;
    @BindView(R.id.plhc_ball_eight_tv)
    TextView mPlhcBallEightTv;
    @BindView(R.id.lhc_animal_eight_tv)
    TextView mLhcAnimalEightTv;
    @BindView(R.id.lable_count_time)
    TextView mLableCountTime;
    @BindView(R.id.lhc_value_count_time)
    ...
    public OpenLotteryLHCView(Context context, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context);
        initUI(context);
    }

    public OpenLotteryLHCView(Context context, @Nullable AttributeSet attrs, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context, attrs);
        initUI(context);
    }

    public OpenLotteryLHCView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context, attrs, defStyleAttr);
        initUI(context);
    }


    public OpenLotteryLHCView(Context context) {
        super(context);
        initUI(context);
    }
    ...
    private void initUI(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_lottery_rcd_lhc, null);
    ...
    public void setViewsData() {
        ...
        if (rcd.getLastOpenCode() != null && 20 == rcd.getLastOpenCode().length()) {
            ...
            if (lastOpenCode != null && lastOpenCode.length == 7) {
                LHCUtil.initBall(mLhcBallOneTv, mLhcAnimalOneTv, lastOpenCode[0]);
                LHCUtil.initBall(mLhcBallTwoTv, mLhcAnimalTwoTv, lastOpenCode[1]);
                LHCUtil.initBall(mLhcBallThreeTv, mLhcAnimalThreeTv, lastOpenCode[2]);
                LHCUtil.initBall(mLhcBallFourTv, mLhcAnimalFourTv, lastOpenCode[3]);
                LHCUtil.initBall(mLhcBallFiveTv, mLhcAnimalFiveTv, lastOpenCode[4]);
                LHCUtil.initBall(mLhcBallSixTv, mLhcAnimalSixTv, lastOpenCode[5]);
                LHCUtil.initBall(mPlhcBallEightTv, mLhcAnimalEightTv, lastOpenCode[6]);
            }
        }
    }
