...
public class OpenLotteryXY28View extends LinearLayout implements View.OnClickListener, ILastLotteryRecView {
    ...
    TextView mSscTime;
    @BindView(R.id.xy28_ball_one_tv)
    TextView mXy28BallOneTv;
    @BindView(R.id.xy28_ball_two_tv)
    TextView mXy28BallTwoTv;
    @BindView(R.id.xy28_ball_three_tv)
    TextView mXy28BallThreeTv;
    @BindView(R.id.xy28_ball_fout_tv)
    TextView mXy28BallFourTv;
    @BindView(R.id.lable_count_time)
    TextView mLableCountTime;
    @BindView(R.id.xy28_value_count_time)
    ...
    public OpenLotteryXY28View(Context context, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context);
        initUI(context);
    }

    public OpenLotteryXY28View(Context context, @Nullable AttributeSet attrs, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context, attrs);
        initUI(context);
    }

    public OpenLotteryXY28View(Context context, @Nullable AttributeSet attrs, int defStyleAttr, Context context1, LayoutInflater layoutInflater, View cqsscView) {
        super(context, attrs, defStyleAttr);
        initUI(context);
    }


    public OpenLotteryXY28View(Context context) {
        super(context);
        initUI(context);
    }
    ...
    private void initUI(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_lottery_rcd_xy28, null);
    ...
    public void setViewsData() {
        ...
        if (rcd.getLastOpenCode() != null && 5 == rcd.getLastOpenCode().length()) {
            ...
            mXy28BallOneTv.setText(lastOpenCode[0]);
            mXy28BallTwoTv.setText(lastOpenCode[1]);
            mXy28BallThreeTv.setText(lastOpenCode[2]);
            mXy28BallThreeTv.setText(lastOpenCode[2]);
            mXy28BallFourTv.setText(String.valueOf(getXy28Sum(lastOpenCode)));
