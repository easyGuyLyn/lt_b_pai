...
public class Cqxync_SM_Fragment extends BaseFragment {
    ...
    private void initData() {
        ThreadUtils.newThread(new Runnable() {
            @Override
            public void run() {
                mList = Cqxync_DataUtils.initCQXYNCSMData();
                for (PlayTypeBean.PlayBean playBean : mList) {
                    mListLinkedHashMap.put(playBean.getPlayTypeName(), Cqxync_DataUtils.init_CQXYNC_SM_Data(playBean.getPlayTypeName()));
                }
