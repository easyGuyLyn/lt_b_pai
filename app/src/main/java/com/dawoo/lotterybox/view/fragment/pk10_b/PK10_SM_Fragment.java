...
public class PK10_SM_Fragment extends BaseFragment {
    ...
    private void initData() {
        mList = PK10BDataUtil.initPK10BSMData();
        for (PlayTypeBean.PlayBean playBean : mList) {
            mListLinkedHashMap.put(playBean.getPlayTypeName(), PK10BDataUtil.init_PK10B_SM_Data(playBean.getPlayTypeName()));
        }
