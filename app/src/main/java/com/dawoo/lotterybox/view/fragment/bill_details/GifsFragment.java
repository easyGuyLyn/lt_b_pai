...
public class GifsFragment extends BaseFragment implements View.OnClickListener {
    ...
    @BindView(R.id.bill_details_anti_water)
    TextView billDetailsAntiWater;
    @BindView(R.id.bill_details_share_gifs)
    TextView billDetailsShareGifs;
    @BindView(R.id.bill_details_all_VIP_gifs)
    TextView billDetailsAllVIPGifs;
    @BindView(R.id.bill_details_all_other_gifs)
    TextView billDetailsAllOtherGifs;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_billing_details_gifts, container, false);
