...
public class LHC_Animal_One_Fragment extends LHC_Com_Base_Fragment {
    @Override
    ...
    void initData() {
        ThreadUtils.newThread(new Runnable() {
            ...
            public void run() {
                needChange = false;
                playList = LHCDataUtils.getAnimationDatasByPosition(getString(R.string.lhc_one_animal));
        ...
        askView.setAskTV("一肖", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((HKSMActivity) getActivity()).showExplainDialog(LHCUtil.getExplianbyCode("positive_animal"));
