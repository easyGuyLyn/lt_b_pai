...
public class K3_SJ_Fragment extends BaseFragment {
    ...
    private void initData() {
        ...
        mList = K3DataUtil.initSJData();
        for (PlayTypeBean.PlayBean playBean : mList) {
            mListLinkedHashMap.put(playBean.getPlayTypeName(), K3DataUtil.init_SJ_Data(playBean.getPlayTypeName()));
        }
    ...
    private class SZPDetailAdapter extends BaseQuickAdapter {
        ...
        protected void convert(BaseViewHolder helper, Object item) {
            ...
            helper.setBackgroundRes(R.id.tv_playType, K3DataUtil.getFastIcon(playDetailBean.getNum()));
