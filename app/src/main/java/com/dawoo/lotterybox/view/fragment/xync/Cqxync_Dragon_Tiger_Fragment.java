...
/**
 * Created by jack on 3-12
 */

public class Cqxync_Dragon_Tiger_Fragment extends BaseFragment {
    ...
    public Cqxync_Dragon_Tiger_Fragment() {
    }
    ...
    private void initData() {
        mList = Cqxync_DataUtils.initCQXYNDiaTigData();
        for (PlayTypeBean.PlayBean playBean : mList) {
            mListLinkedHashMap.put(playBean.getPlayTypeName(), Cqxync_DataUtils.init_CQXYNC_DvsT_Data(playBean.getPlayTypeName()));
        }
