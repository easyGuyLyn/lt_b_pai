...
public class CancelNumRecordHis implements Parcelable {
    ...
    public CancelNumRecordHis() {
    }

    protected CancelNumRecordHis(Parcel in) {
    ...
    public static final Creator<CancelNumRecordHis> CREATOR = new Creator<CancelNumRecordHis>() {
        @Override
        public CancelNumRecordHis createFromParcel(Parcel source) {
            return new CancelNumRecordHis(source);
        }

        @Override
        public CancelNumRecordHis[] newArray(int size) {
            return new CancelNumRecordHis[size];
        }
    };
}
